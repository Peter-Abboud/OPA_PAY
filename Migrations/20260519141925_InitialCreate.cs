        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        ...
                        onDelete: ReferentialAction.Restrict);
                    table.ForeignKey(
                        name: "FK_Transfers_Beneficiaries_BeneficiaryId",
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_Receipts_Transfers_TransferId",
            ...
            migrationBuilder.InsertData(
                table: "Commissions",
                columns: new[] { "Id", "FixedAmount", "IsActive", "Percentage" },
                values: new object[] { 1, 1m, true, 2m });

            migrationBuilder.InsertData(
                table: "Currencies",
                columns: new[] { "Id", "Code", "ExchangeRate", "Name" },
                values: new object[,]
                {
                    { 1, "USD", 1m, "US Dollar" },
                    { 2, "EUR", 0.92m, "Euro" },
                    { 3, "LBP", 89500m, "Lebanese Pound" }
                });
            ...
            migrationBuilder.CreateIndex(
                name: "IX_Transfers_BeneficiaryId",
                table: "Transfers",
